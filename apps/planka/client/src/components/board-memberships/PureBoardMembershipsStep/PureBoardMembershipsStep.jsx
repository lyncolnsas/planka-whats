...
import WhatsAppMemberInvite from './WhatsAppMemberInvite';
...
const PureBoardMembershipsStep = React.memo(
  ({
    ...
    // Board name and current user name for the WhatsApp invite
    ...
    return (
      <>
        ...
        <Popup.Content>
          ...
          {/* WhatsApp invite section — hidden gracefully if bridge is offline */}
          <WhatsAppMemberInvite
            searchTerm={search}
            boardName={boardName}
