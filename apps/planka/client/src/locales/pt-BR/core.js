...
export default {
  ...
  format: {
    ...
    longDate: 'd MMM',
    longDateTime: "d 'de' MMMM 'às' HH:mm",
    fullDate: 'd MMM, y',
    fullDateTime: "d 'de' MMMM, y 'às' HH:mm",
  },

  translation: {
    common: {
      aboutApp_title: 'Sobre o aplicativo',
      aboutSystem_title: 'Sobre o sistema',
      ...
      simpleNoteAndTextRecording: 'Registro simples de notas e textos.',
      smtp: 'SMTP',
      ...
      waAdmin: 'Administrador Proprietário',
      waEditor: 'Usuário do Quadro (Editor)',
      waViewer: 'Somente Leitura (Viewer)',
      waAdminDescription: 'Poderes totais sobre o projeto e o bot.',
      waEditorDescription: 'Pode criar e mover tarefas via WhatsApp.',
      waViewerDescription: 'Pode apenas visualizar tarefas via WhatsApp.',
    },
